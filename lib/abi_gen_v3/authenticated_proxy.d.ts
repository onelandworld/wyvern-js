...
export declare type AuthenticatedProxyEventArgs = AuthenticatedProxyReceivedEtherEventArgs | AuthenticatedProxyReceivedTokensEventArgs | AuthenticatedProxyRevokedEventArgs;
...
export declare class AuthenticatedProxyContract extends BaseContract {
    ...
    registry(): ContractTxFunctionObj<string>;
    revoked(): ContractTxFunctionObj<boolean>;
    upgradeabilityOwner(): ContractTxFunctionObj<string>;
    user(): ContractTxFunctionObj<string>;
    ...
    proxy(dest: string, howToCall: number | BigNumber, data: string): ContractTxFunctionObj<boolean>;
    proxyAssert(dest: string, howToCall: number | BigNumber, data: string): ContractTxFunctionObj<void>;
    /**
