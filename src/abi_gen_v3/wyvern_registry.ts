...
export type WyvernRegistryEventArgs =
    | WyvernRegistryOwnershipTransferredEventArgs;

export enum WyvernRegistryEvents {
...
export class WyvernRegistryContract extends BaseContract {
    /**
     * @ignore
     */
public static deployedBytecode: string | undefined;
public static contractName = 'WyvernRegistry';
    private readonly _methodABIIndex: { [name: string]: number } = {};
private readonly _subscriptionManager: SubscriptionManager<WyvernRegistryEventArgs, WyvernRegistryEvents>;
public static async deployFrom0xArtifactAsync(
    ...
    public static async deployWithLibrariesFrom0xArtifactAsync(
        ...
        const libraryAddresses = await WyvernRegistryContract._deployLibrariesAsync(
            artifact,
            libraryArtifacts,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`WyvernRegistry successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new WyvernRegistryContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
        ...
        for (const link of Object.values(links)) {
            for (const libraryName of Object.keys(link)) {
                if (!libraryAddresses[libraryName]) {
                    ...
                    await WyvernRegistryContract._deployLibrariesAsync(
                        libraryArtifact,
                        libraryArtifacts,
                        web3Wrapper,
                        txDefaults,
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = WyvernRegistryContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    public getABIDecodedTransactionData<T>(methodName: string, callData: string): T {
        ...
        const self = (this as any) as WyvernRegistryContract;
...
> {
    ...
    public startGrantAuthentication(
            addr: string,
    ): ContractTxFunctionObj<void
> {
        const self = this as any as WyvernRegistryContract;
...
> {
    ...
    public grantInitialAuthentication(
            authAddress: string,
    ): ContractTxFunctionObj<void
> {
        const self = this as any as WyvernRegistryContract;
            assert.isString('authAddress', authAddress);
     ...
     */
    public subscribe<ArgsType extends WyvernRegistryEventArgs>(
        eventName: WyvernRegistryEvents,
        indexFilterValues: IndexedFilterValues,
        callback: EventCallback<ArgsType>,
        isVerbose: boolean = false,
        blockPollingIntervalMs?: number,
    ): string {
        assert.doesBelongToStringEnum('eventName', eventName, WyvernRegistryEvents);
     ...
     */
    public async getLogsAsync<ArgsType extends WyvernRegistryEventArgs>(
        eventName: WyvernRegistryEvents,
    ...
    constructor(
        ...
        txDefaults?: Partial<TxData>,
        logDecodeDependencies?: { [contractName: string]: ContractAbi },
        deployedBytecode: string | undefined = WyvernRegistryContract.deployedBytecode,
...
this._subscriptionManager = new SubscriptionManager<WyvernRegistryEventArgs, WyvernRegistryEvents>(
            WyvernRegistryContract.ABI(),
            this._web3Wrapper,
        );
