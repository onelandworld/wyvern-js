...
export class StaticMarketContract extends BaseContract {
    /**
     * @ignore
     */
public static deployedBytecode: string | undefined;
public static contractName = 'StaticMarket';
...
public static async deployFrom0xArtifactAsync(
    ...
    public static async deployWithLibrariesFrom0xArtifactAsync(
        ...
        const libraryAddresses = await StaticMarketContract._deployLibrariesAsync(
            artifact,
            libraryArtifacts,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`StaticMarket successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new StaticMarketContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
        ...
        for (const link of Object.values(links)) {
            for (const libraryName of Object.keys(link)) {
                if (!libraryAddresses[libraryName]) {
                    ...
                    await StaticMarketContract._deployLibrariesAsync(
                        libraryArtifact,
                        libraryArtifacts,
                        web3Wrapper,
                        txDefaults,
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = StaticMarketContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    public getABIDecodedTransactionData<T>(methodName: string, callData: string): T {
        ...
        const self = (this as any) as StaticMarketContract;
...
> {
    ...
    constructor(
        ...
        txDefaults?: Partial<TxData>,
        logDecodeDependencies?: { [contractName: string]: ContractAbi },
        deployedBytecode: string | undefined = StaticMarketContract.deployedBytecode,
